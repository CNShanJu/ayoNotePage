'object' == typeof navigator &&
    (function (e, t) {
        ...
        const k = (e) => (null != e ? e.constructor : null),
            ...
            x = (e) => C(e, NodeList),
            M = (e) =>
                A(e) || ((E(e) || N(e) || x(e)) && !e.length) || (S(e) && !Object.keys(e).length);
        var I = A,
            L = S,
        ...
        const We = {
            ...
            createButton(e, t) {
                ...
                return (
                    n.toggle
                        ? (a.appendChild(
                              We.createIcon.call(this, n.iconPressed, { class: 'icon--pressed' })
                          ),
                          a.appendChild(
                              We.createIcon.call(this, n.icon, { class: 'icon--not-pressed' })
                          ),
                          a.appendChild(
                              We.createLabel.call(this, n.labelPressed, { class: 'label--pressed' })
                          ),
                          a.appendChild(
                              We.createLabel.call(this, n.label, { class: 'label--not-pressed' })
                          ))
            ...
            createRange(e, t) {
                ...
                return (
                    (this.elements.inputs[e] = i), We.updateRangeFill.call(this, i), T.setup(i), i
                );
            },
            createProgress(e, t) {
                const i = Z(
                ...
                return (
                    Ce(q(this.config.controls) ? this.config.controls : []).forEach((l) => {
                        ...
                        if (
                            ...
                            const s = Z(
                                'div',
                                X({}, h, { class: `${h.class} plyr__menu`.trim(), hidden: '' })
                            );
                            s.appendChild(
            ...
            constructor(t) {
                e(this, 'load', () => {
                    ...
                    e(
                        ...
                        'on',
                        (e, t) => (
                            q(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this
                        )
                    ),

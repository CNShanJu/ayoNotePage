...
![image-20240111115350258](1_输入和输出图片/image-20240111115350258.png)
...
![image-20240111115413293](1_输入和输出图片/image-20240111115413293.png)

如果要把数据显示成我们期望的格式，就需要使用格式化输出的功能。格式化输出使用`System.out.printf()`，通过使用占位符`%?`，`printf()`可以把后面的参数格式化成指定格式：

![image-20240111115452921](1_输入和输出图片/image-20240111115452921.png)
...
![image-20240111115521648](1_输入和输出图片/image-20240111115521648.png)

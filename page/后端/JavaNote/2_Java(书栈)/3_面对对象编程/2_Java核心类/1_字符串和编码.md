...
![字符串和编码 - 图1](img/1_字符串和编码/2744346b850a5fa88a2959e924d9bf6c.png)
...
![字符串和编码 - 图2](img/1_字符串和编码/d4b0f648b774121ed66a31ccfdeecc06.png)
...
![字符串和编码 - 图3](img/1_字符串和编码/af8e67aeb74670f5b58adc253d7378f7.png)
...
![字符串和编码 - 图4](img/1_字符串和编码/1c967967b8fb079e1d0325dfd81fdd98.png)
...
要把任意`基本类型`或`引用类型`转换为字符串，可以使用静态方法`valueOf()`。这是一个重载方法，编译器会根据参数自动选择合适的方法：
...
![字符串和编码 - 图5](img/1_字符串和编码/bc400f2b72948fbe33d955dfe8c83bfc.png)
...
![字符串和编码 - 图6](img/1_字符串和编码/5fb4b92274e5b62bd0ca69cac3333558.png)

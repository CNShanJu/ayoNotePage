...
![BigDecimal - 图1](img/9_BigDecimal/837a5e470d2ce779f939a57a61ac86f6.png)
...
![BigDecimal - 图2](img/9_BigDecimal/f43fc24b927846f632b7ac92a3a50870.png)
...
总是使用`compareTo()`比较两个BigDecimal的值，**不要使用equals()**！

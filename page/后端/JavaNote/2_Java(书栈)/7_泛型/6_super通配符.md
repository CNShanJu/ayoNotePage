...
![super通配符 - 图1](img/6_super通配符/1974bb64da19666be80225992c9f14e7.png)
...
何时使用`extends`，何时使用`super`？为了便于记忆，我们可以用PECS原则：Producer Extends Consumer Super（生产者扩展消费者超级）。
...
![super通配符 - 图2](img/6_super通配符/aaf1ed1a5389e40b88c10344196448f5.png)
